const BASE_URL =
	"https://firebasestorage.googleapis.com/v0/b/erp-system-tedkvn.appspot.com/o/env%2F";

const BASE_TOKEN = "";

const getAsset = (fileName = "", token = BASE_TOKEN) =>
	`${BASE_URL}${fileName}?alt=media&token=${token}`;

export const medias = {
	signInBg: () =>
		getAsset("sign-in-bg.png", "af90f3de-d313-4ea9-af64-84c094516247"),
	logo: () => getAsset("logo.png", "1e3ab64e-e9d8-4fa6-b726-a0a3e3ee9a72"),
	loading: () =>
		getAsset("loading.png", "5bb0ceb1-b0e8-49bb-9404-e60a1f035e2d"),
	404: () => getAsset("404.png", "99b2e618-3684-47ed-b164-d9ec67da1bec"),
	oops: () => getAsset("Oops.svg", "930313d6-fa22-4f95-a6ca-a1dd8e9e16dd"),
};

// export const signInBg = `${BASE_URL}sign-in-bg.png?alt=media&token=${token}`;

// export const logo = `${BASE_URL}logo.png?alt=media&token=${token}`;
// // https://firebasestorage.googleapis.com/v0/b/erp-system-tedkvn.appspot.com/o/env%2Floading.png?alt=media&token=5bb0ceb1-b0e8-49bb-9404-e60a1f035e2d

// export const loading = `${BASE_URL}2Floading.png?alt=media&token=${token}`;

// export const image404 = `${BASE_URL}404.png?alt=media&token=${token}`;
